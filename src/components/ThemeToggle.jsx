...
export default function ThemeToggle() {
  ...
  const handleToggle = () => {
    ...
    setShowMessage(true);
    setSpin(true);
    setTimeout(() => setSpin(false), 500); // match animation duration
  };
      ...
      <AnimatePresence>
        {showMessage && (
          ...
          >
            ...
            >
              <p className="text-white text-lg mb-1">{wittyMessage}</p>
              <p className="text-blue-400 text-base mt-1">{wittySub}</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
